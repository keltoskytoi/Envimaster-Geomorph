...
The function REAVER hyperspace is used to perform ordination and cluster analysis on a dataframe to get  information from an n-dimensional hyperspace. (see LEYER, I. & K. WESCHE (2007): Multivariate Statistik in der Ökologie. Eine Einführung.) for further information about multi variant statistics.
