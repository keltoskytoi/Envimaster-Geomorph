...
#load function to save plot as png, 
...
# Hohlform 112
## Profil 112.1
plotname <- "Profil_112.1" # name of the created plot
...
# Hohlform 19
## Profil 19.1
plotname <- "Profil_19.1"

tiefe <- c(-10, -20, -30, -40, -50, -60)
schlaege <- c(24, 33 ,22, 35, 39, 34)
plot_profile(output=out,depth = tiefe, strikes = schlaege, plotname= plotname,title = plot_title)
## Profil 19.2
plotname <- "Profil_19.2"

tiefe <- c(-10, -20, -30, -40)
schlaege <- c(21, 13, 30, 40)
plot_profile(output=out,depth = tiefe, strikes = schlaege, plotname= plotname,title = plot_title)
## Profil 19.3
plotname <-  "Profil_19.3"
...
# Hohlform 116
##Profil 116.1
plotname <- "Profil_116.1"

tiefe <- c(-10, -20, -30, -40)
schlaege <- c(5, 15, 13, 26)
plot_profile(output=out,depth = tiefe, strikes = schlaege, plotname= plotname,title = plot_title)
## Profil 116.2
plotname <- "Profil_116.2"

tiefe <- c(-10, -20, -30, -40, -50, -60, -70)
schlaege <- c(6, 9, 11, 7, 23 ,50, 80)
plot_profile(output=out,depth = tiefe, strikes = schlaege, plotname= plotname,title = plot_title)
## Profil 116.3
plotname <- "Profil_116.3"
