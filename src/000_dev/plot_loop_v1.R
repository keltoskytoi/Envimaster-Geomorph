...
#set output path
output=envrmt$path_künzelplots

#load fucntion to save plot as png, 
#output = outputpath (perdefine recommended)
#titel = optional plot the diagramm in R, default is TRUE

plot_profile <- function(output,depth, strikes, plotname,titel=TRUE){
  #perpare df
  data <- data.frame(
    Depth=depth ,  
    Strikes=strikes
...
plot_profile(output,depth = tiefe, strikes = schlaege, plotname,titel = T)
## Profil 1.2
plotname <- "Profil_1.2"
